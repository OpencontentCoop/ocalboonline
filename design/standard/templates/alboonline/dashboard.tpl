...
$(document).ready(function () {
	...
	$.fn.editable.defaults.emptytext = 'Non specificato';
    ...
    var dataTable = $('.table-container').opendataDataTable({
            ...
            "columnDefs": [
            	...
            	},
            	{
            		"render": function ( data, type, row, meta ) {            			            			
            			...
            			return '<a href="#" class="editable" data-type="text" data-name="progressivo_albo" data-pk="'+row.metadata.id+'" data-url="/edit/attribute/'+row.metadata.id+'/progressivo_albo/1" data-title="Imposta progressivo">'+value+'</a>'
            		},
            		"targets": [1]
            	},
            	{
    	...
    	$('a.alboonline-link').on('click', function(e){
			if (e.shiftKey) {	            
