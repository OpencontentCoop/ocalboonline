...
{default attribute_base=ContentObjectAttribute}
    <div id="uploader_{$attribute_base}_data_multibinaryfilename_{$attribute.id}">
        ...
        {/if}
        {if and($disallow_upload|not(), or($file_count|lt( $attribute.contentclass_attribute.data_int2 ), $attribute.contentclass_attribute.data_int2|eq(0) ))}
